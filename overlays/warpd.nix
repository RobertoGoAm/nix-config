# nixpkgs only ships warpd for Linux (X11/Wayland); its...
...
prev.lib.optionalAttrs prev.stdenv.hostPlatform.isDarwin {
  warpd = prev.stdenv.mkDerivation {
    ...
    # mk/macos.mk's `all` target runs codesign/sign.sh after linking —...
    ...
    # warpd declares tentative globals (e.g. nr_boxes) in shared headers....
