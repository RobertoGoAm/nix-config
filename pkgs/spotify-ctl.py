...
# The URI registered on the application. smudge is aliased onto this same
# path, so one registration serves both clients. Only the authorization_code
# exchange sends it; refreshing does not.
