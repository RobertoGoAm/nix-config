  ...
  profileType = types.submodule {
    options = {
      ...
      transparency = mkOption {
        type = types.float;
        default = 0.0;
        description = "Window transparency (0.0 = opaque, 1.0 = fully transparent).";
      };
      ...
      hotkey = {
        enabled = mkOption {
          type = types.bool;
          default = false;
          description = "Enable hotkey window.";
        };

        characters = mkOption {
          type = types.str;
          default = "'";
          description = "Hotkey characters.";
        };

        modifierFlags = mkOption {
          type = types.int;
          default = 1048576; # Command key
          description = "Hotkey modifier flags.";
        };
        ...
        autoHides = mkOption {
          type = types.bool;
          default = true;
          description = "Hotkey window auto-hides.";
        };

        floats = mkOption {
          type = types.bool;
          default = true;
          description = "Hotkey window floats.";
        };

        animates = mkOption {
          type = types.bool;
          default = true;
          description = "Hotkey window animates.";
        };

        keyCode = mkOption {
          type = types.int;
          default = 50; # Single quote key
          description = "Hotkey key code.";
        };

        modifierActivation = mkOption {
          type = types.int;
          default = 0;
          description = "Hotkey modifier activation.";
        };

        dockClickAction = mkOption {
          type = types.int;
          default = 0;
          description = "Hotkey dock click action.";
        };

        reopensOnActivation = mkOption {
          type = types.bool;
          default = false;
          description = "Hotkey window reopens on activation.";
        };
      };
      ...
      blend = mkOption {
        type = types.float;
        default = 0.0;
        description = "Window blend factor.";
      };
      ...
      disableWindowResizing = mkOption {
        type = types.bool;
        default = false;
...
in {
  options.programs.iterm2 = {
    ...
    settings = {
      ...
      general = {
        hapticFeedbackForEsc = mkOption {
          type = types.bool;
          default = false;
          description = "Enable haptic feedback for ESC key.";
        };

        soundForEsc = mkOption {
          type = types.bool;
          default = false;
          description = "Enable sound for ESC key.";
        };

        visualIndicatorForEsc = mkOption {
          type = types.bool;
          default = false;
          description = "Enable visual indicator for ESC key.";
        };

        ignoreSystemWindowRestoration = mkOption {
          type = types.bool;
          default = true;
          description = "Ignore system window restoration.";
        };

        windowRestoresWorkspaceAtLaunch = mkOption {
          type = types.bool;
          default = false;
          description = "Window restores workspace at launch.";
        };

        hotkeyMigratedFromSingleToMulti = mkOption {
          type = types.bool;
          default = true;
          description = "Hotkey migrated from single to multi.";
        };

        confirmQuit = mkOption {
          type = types.bool;
          default = true;
          description = "Show confirmation dialog when quitting iTerm2.";
        };

        hideMenuBarInFullscreen = mkOption {
          type = types.bool;
          default = true;
          description = "Hide menu bar in fullscreen mode.";
        };

        showFullScreenTabBar = mkOption {
          type = types.bool;
          default = false;
          description = "Show tab bar in fullscreen mode.";
        };

        flashTabBarInFullscreen = mkOption {
          type = types.bool;
          default = false;
          description = "Flash tab bar in fullscreen mode.";
        };
        ...
        launchAtLogin = mkOption {
          type = types.bool;
          default = false;
          description = "Launch iTerm2 at login.";
        };
      };
    ...
    home.activation = mkMerge [
      (mkIf cfg.copyApplications {
        copyITerm2ToApplications = lib.hm.dag.entryAfter [ "writeBoundary" ] ''
          # Check if iTerm2 is running using AppleScript (no external dependencies)
          if osascript -e 'tell application "System Events" to get name of every process' 2>/dev/null | grep -q "iTerm2"; then
            echo "Warning: iTerm2 is currently running. Please quit iTerm2 before running this activation."
            echo "You can quit iTerm2 by running: osascript -e 'quit app \"iTerm2\"'"
            exit 1
          fi
