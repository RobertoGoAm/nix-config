...
}:
{
  programs.git = {
    ...
    settings = {
      ...
      # "merges" not true: a plain rebase flattens merge commits and...
      ...
      # SSH commit signing — generic plumbing only. The per-identity...
    ...
    # Real identities (the personal default + per-client gitdir includes,...
