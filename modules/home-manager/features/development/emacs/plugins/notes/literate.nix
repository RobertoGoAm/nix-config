...
{ pkgs, config, ... }:
{
  ...
  programs.emacs.extraConfig = ''
    ...
    so the editor and the batch tangler agree on where output goes."
        ...
        ;; Declared because the `let's below bind it and ob-core is not loaded
        ;; when this file is compiled: an unbound-at-compile-time symbol binds
        ;; lexically, and a tangle could still stop to ask.
