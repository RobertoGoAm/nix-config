...
let
  ...
  # One item, not seven. SwiftBar gives each plugin its own menu bar...
...
lib.mkIf pkgs.stdenv.hostPlatform.isDarwin {
  ...
  # macmon reads Apple Silicon's counters through IOReport, so the...
  ...
  # Point SwiftBar at the managed directory so the plugins are whatever...
